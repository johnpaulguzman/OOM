...
\n \dfn{PDF}(P_X, (X, \Omega, \mathcal{F}, P)) \iff (\rfr{randomVariable}(X, (\Omega, \mathcal{F}, P))) \land 
...
\m (\exists_{E \subseteq \mathbb{R}} (\rfr{countablyInfinite}(E) \land P_X(E) = 1)) \land ((e)_\mathbb{N} = E) \land (\forall_{i \in \mathbb{N}} \forall_{j \in \mathbb{N} \setminus \{i\}} (e_i \cap e_j = \emptyset))
