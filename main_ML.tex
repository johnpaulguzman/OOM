...
\n \dfn{lebesgueMeasure}\ml(\lambda, \ml(\mr)\mr) \iff \ml(\rfr{borelSigmaAlgebra}\ml(\sigma\ml(\rfr{standardTopology}\mr), \ml(\mathbb{R}^d, \rfr{standardTopology}\mr)\mr)\mr) \land
\m \ml(\rfr{measure}\ml(\lambda, \ml(\mathbb{R}^d, \sigma\ml(\rfr{standardTopology}\mr)\mr)\mr)\mr) \land
