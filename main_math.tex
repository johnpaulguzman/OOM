...
\begin{tcolorbox}[breakable, enhanced]
\begin{align}
    \n \notes{Thm1: let $E$ be a formula consisting of the atoms $P_1, ..., P_n$, }
    ...
    \n \notes{Thm2: let $E$ be a formula consisting of formulas; with the same reasoning in Thm1, if $\vDash E$, then $\vDash E^*$}
    \n \TODO{Thms and axioms for propositional calculus}
\end{align}
\end{tcolorbox}


\subsection{Model theory: implication and equivalence}
\begin{tcolorbox}[breakable, enhanced]
\begin{align}
    \n \notes{}
\end{align}
