...
\m \thmlink{POS-LCom}{THM-LAsc-17} (((\rfr{\lnot} x \rfr{\land} x) \rfr{\lor} (\rfr{\lnot} x \rfr{\land} y)) \rfr{\lor} (\rfr{\lnot} x \rfr{\land} z) = (\rfr{F} \rfr{\lor} (\rfr{\lnot} x \rfr{\land} y)) \rfr{\lor} (\rfr{\lnot} x \rfr{\land} z)) \cusand \cusand
...
\m \thmlink{}{} (A = A \rfr{\land} \rfr{T}) \cusand \cusand
\m \thmlink{}{} (A = A \rfr{\land} (x \rfr{\lor} \rfr{\lnot} x)) \cusand \cusand
\m \thmlink{}{} (A \rfr{\land} (x \rfr{\lor} \rfr{\lnot} x) = (x \rfr{\land} A) \rfr{\lor} (\rfr{\lnot} x \rfr{\land} A)) \cusand \cusand
